  ...
  _init() {
    ...
    if (crosshairs) {
      if (crosshairs.type === "rect") {
        this.set(
          "crosshairs",
          Util.deepMix({}, Global.tooltipCrosshairsRect, crosshairs)
        );
        ...
        this.set(
          "crosshairs",
          Util.deepMix({}, Global.tooltipCrosshairsLine, crosshairs)
        );
    ...
    if (!isChanged) {
      Util.each(items, (item, index) => {
        ...
        isChanged =
          ...
          item.color !== preItem.color ||
          item.name !== preItem.name ||
          item.title !== preItem.title;
        if (isChanged) {
          return false;
        }
      });
