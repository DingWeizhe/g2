...
describe("测试圆轴", function() {
  ...
  it("测试文本自动旋转－情况1", function() {
    ...
    expect(textChildren.get("children")[0].attr("matrix")).not.eql([
      1,
      0,
      0,
      0,
    ...
    expect(textChildren.get("children")[1].attr("matrix")).to.eql([
      1,
      0,
      0,
      0,
  ...
  xit("测试文本自动旋转－情况2", function() {
    ...
    expect(textChildren.get("children")[6].attr("matrix")).to.eql([
      1,
      0,
      0,
      0,
    ...
    expect(textChildren.get("children")[16].attr("matrix")).to.eql([
      1,
      0,
      0,
      0,
